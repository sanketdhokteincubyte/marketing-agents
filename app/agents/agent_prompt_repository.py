...
agent_prompt_repository = {
    ...
    AgentType.MED_STANDARDIZER_SINGLE_AGENT: "Transform the uploaded medical data to standardized FHIR R4 format. Analyze the data structure and create valid FHIR resources with quality assessment.",
    AgentType.HL7_TO_FHIR_AGENT: "Transform the uploaded HL7 message to FHIR R4 format. Please analyze the HL7 segments and create valid FHIR resources.",
